...
export default class Carpet {
    constructor(
        ...
        if (!material) return console.error("Missing material")
        ...
        this.dom.classList.add("aladino");  // ------------------------------------ 원본 엘리먼트 클래스명 추가
        this.dom.style.opacity = "0";       // ------------------------------------ 원본 엘리먼트 숨기기 
    ...
    updateProjection() {
        ...
        this.projection.fromPerspective({ fov, aspect, near: 0.01, far: 100, });

        this.projection.translate([0, 0, -distance, 0]);

        this.projection.translate([
            -(camWidth / 2) + scaleX / 2, camHeight / 2 - scaleY / 2,
            0, 0,
        ]);
